 ...
 * @example
 * const raw =
 *  "web_scraper.py\r\n\r\n[Python Interpreter: /agentmojo/poetry/agentmojo-5O4_aCHf-py3.12/bin/python]\nagentmojo@659478cb008c:/workspace $ ";
 *
 * const parsed = parseTerminalOutput(raw);
 *
 * console.log(parsed.output); // web_scraper.py
 * console.log(parsed.symbol); // agentmojo@659478cb008c:/workspace $
 */
