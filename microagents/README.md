# AgentMojo MicroAgents

MicroAgents are specialized prompts that enhance AgentMojo with domain-specific knowledge and task-specific workflows. They help developers by providing expert guidance, automating common tasks, and ensuring consistent practices across projects. Each microagent is designed to excel in a specific area, from Git operations to code review processes.

## Sources of Microagents

AgentMojo loads microagents from two sources:

### 1. Shareable Microagents (Public)
This directory (`AgentMojo/microagents/`) contains shareable microagents that are:
- Available to all AgentMojo users
- Maintained in the AgentMojo repository
...
Each repository can have its own instructions in `.agentmojo/microagents/repo.md`. These instructions are:
...
When AgentMojo works with a repository, it:
1. Loads repository-specific instructions from `.agentmojo/microagents/repo.md` if present
...
You can see an example of a knowledge-based agent in [AgentMojo's github microagent](https://github.com/All-Hands-AI/AgentMojo/tree/main/microagents/knowledge/github.md).

### 2. Repository Agents

Repository agents provide repository-specific knowledge and guidelines. They are:
- Loaded from `.agentmojo/microagents/repo.md`
...
You can see an example of a repo agent in [the agent for the AgentMojo repo itself](https://github.com/All-Hands-AI/AgentMojo/blob/main/.agentmojo/microagents/repo.md).
...
Example workflow:
You can see an example of a task-based agent in [AgentMojo's pull request updating microagent](https://github.com/All-Hands-AI/AgentMojo/tree/main/microagents/tasks/update_pr_description.md).
...
1. Create your agent file in the appropriate directory:
   ...
   - Note: Repository agents should remain in their respective repositories' `.agentmojo/microagents/` directory
2. Test thoroughly
3. Submit a pull request to AgentMojo


## License

All microagents are subject to the same license as AgentMojo. See the root LICENSE file for details.
