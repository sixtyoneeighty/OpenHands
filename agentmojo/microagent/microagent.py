...
from agentmojo.microagent.types import MicroAgentMetadata, MicroAgentType
...
class BaseMicroAgent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .agentmojo_instructions
        if path.name == '.agentmojo_instructions':
...
class RepoMicroAgent(BaseMicroAgent):
    ...
    RepoMicroAgents are loaded from `.agentmojo/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .agentmojo/microagents)
    ...
    # Load all agents from .agentmojo/microagents directory
