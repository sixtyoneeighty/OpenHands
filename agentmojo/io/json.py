...
from agentmojo.core.exceptions import LLMResponseError
from agentmojo.events.event import Event
from agentmojo.events.observation import CmdOutputMetadata
from agentmojo.events.serialization import event_to_dict
from agentmojo.llm.metrics import Metrics


class AgentMojoJSONEncoder(json.JSONEncoder):
...
_json_encoder = AgentMojoJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    return json.dumps(obj, cls=AgentMojoJSONEncoder, **kwargs)
