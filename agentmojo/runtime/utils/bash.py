...
from agentmojo.events.action import CmdRunAction
from agentmojo.events.observation import ErrorObservation
...
class BashSession:
    ...
    def initialize(self):
        ...
        if self.username in ['root', 'agentmojo']:
        ...
        session_name = f'agentmojo-{self.username}-{uuid.uuid4()}'
