...
from agentmojo.core.exceptions import (
    AgentRuntimeDisconnectedError,
    AgentRuntimeNotFoundError,
)
from agentmojo.core.logger import DEBUG, DEBUG_RUNTIME
from agentmojo.core.logger import agentmojo_logger as logger
from agentmojo.events import EventStream
from agentmojo.runtime.builder import DockerRuntimeBuilder
from agentmojo.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from agentmojo.runtime.impl.docker.containers import stop_all_containers
...
from agentmojo.runtime.utils.log_streamer import LogStreamer
from agentmojo.runtime.utils.runtime_build import build_runtime_image
from agentmojo.utils.async_utils import call_sync_from_async
from agentmojo.utils.shutdown_listener import add_shutdown_listener
from agentmojo.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'agentmojo-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _init_container(self):
        ...
        if (
            ...
            # e.g. result would be: {"/home/user/agentmojo/workspace": {'bind': "/workspace", 'mode': 'rw'}}
            volumes = {
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/agentmojo/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None):
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'agentmojo-sandbox-' prefix
        """
        super().close()
