"""File operations module for AgentMojo agent.

This module provides a collection of file manipulation skills that enable the AgentMojo
...
from agentmojo.linter import DefaultLinter, LintResult
