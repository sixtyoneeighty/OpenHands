# AgentMojo Skill Sets

This folder implements a skill/tool set `agentskills` for AgentMojo.
...
The skill set can contain a bunch of wrapped tools for agent ([many examples here](https://github.com/All-Hands-AI/AgentMojo/pull/1914)), for example:
