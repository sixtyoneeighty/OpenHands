...
from agentmojo.agenthub.browsing_agent.response_parser import BrowsingResponseParser
...
from agentmojo.core.message import ImageContent, Message, TextContent
...
from agentmojo.events.observation import BrowserOutputObservation
...
"""
    ...
    def step(self, state: State) -> Action:
        ...
        # we should also send a message back to the user in AgentMojo and call it a day
        if (
