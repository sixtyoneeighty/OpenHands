...
from agentmojo.core.message import Message
from agentmojo.llm.debug_mixin import DebugMixin
from agentmojo.llm.fn_call_converter import (
    STOP_WORDS,
    convert_fncall_messages_to_non_fncall_messages,
    convert_non_fncall_messages_to_fncall_messages,
)
from agentmojo.llm.metrics import Metrics
from agentmojo.llm.retry_mixin import RetryMixin
...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        # Azure issue: https://github.com/All-Hands-AI/AgentMojo/issues/6777
