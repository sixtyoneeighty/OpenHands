# AgentMojo Message Format and litellm Integration

## Overview

AgentMojo uses its own `Message` class (`agentmojo/core/message.py`) which provides rich content support while maintaining compatibility with litellm's message handling system.

## Class Structure

Our `Message` class (`agentmojo/core/message.py`):
