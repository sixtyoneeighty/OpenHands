...
from agentmojo.core.exceptions import LLMMalformedActionError
...
from agentmojo.events.action.commands import (
    CmdRunAction,
...
def handle_action_deprecated_args(args: dict) -> dict:
    # keep_prompt has been deprecated in https://github.com/All-Hands-AI/AgentMojo/pull/4881
