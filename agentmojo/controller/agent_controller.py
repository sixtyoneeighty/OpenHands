...
from agentmojo.controller.agent import Agent
from agentmojo.controller.replay import ReplayManager
from agentmojo.controller.state.state import State, TrafficControlState
from agentmojo.controller.stuck import StuckDetector
from agentmojo.core.config import AgentConfig, LLMConfig
...
from agentmojo.core.logger import LOG_ALL_EVENTS
from agentmojo.core.logger import agentmojo_logger as logger
from agentmojo.core.schema import AgentState
from agentmojo.events import (
    EventSource,
    EventStream,
...
from agentmojo.events.action.agent import RecallAction
...
from agentmojo.events.serialization.event import event_to_trajectory, truncate_content
from agentmojo.llm.llm import LLM
from agentmojo.llm.metrics import Metrics, TokenUsage
...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        AgentMojo is a multi-agentic system. A `task` is a conversation between
        AgentMojo (the whole system) and the user, which might involve one or more inputs
