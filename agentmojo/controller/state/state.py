...
from agentmojo.controller.state.task import RootTask
...
from agentmojo.events.action.agent import AgentFinishAction
from agentmojo.events.event import Event, EventSource
from agentmojo.llm.metrics import Metrics
from agentmojo.storage.files import FileStore
from agentmojo.storage.locations import get_conversation_agent_state_filename
...
class State:
    """
    Represents the running state of an agent in the AgentMojo system, saving data of its operation and memory.
