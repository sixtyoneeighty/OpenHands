...
from agentmojo.controller import AgentController
from agentmojo.controller.agent import Agent
from agentmojo.controller.state.state import State
from agentmojo.core.config import AgentConfig, AppConfig, LLMConfig
from agentmojo.core.exceptions import AgentRuntimeUnavailableError
from agentmojo.core.logger import AgentMojoLoggerAdapter
from agentmojo.core.schema.agent import AgentState
from agentmojo.events.action import ChangeAgentStateAction, MessageAction
from agentmojo.events.event import EventSource
from agentmojo.events.stream import EventStream
from agentmojo.memory.memory import Memory
from agentmojo.microagent.microagent import BaseMicroAgent
from agentmojo.runtime import get_runtime_cls
from agentmojo.runtime.base import Runtime
from agentmojo.runtime.impl.remote.remote_runtime import RemoteRuntime
...
class AgentSession:
    ...
    def __init__(
        ...
        self.logger = AgentMojoLoggerAdapter(
    ...
    async def _create_memory(
        ...
        if self.runtime:
            ...
            # loads microagents from repo/.agentmojo/microagents
