...
from agentmojo.core.config.condenser_config import (
    LLMSummarizingCondenserConfig,
)
from agentmojo.core.const.guide_url import TROUBLESHOOTING_URL
...
from agentmojo.server.session.agent_session import AgentSession
...
class Session:
    ...
    def __init__(
        ...
        self.logger = AgentMojoLoggerAdapter(extra={'session_id': sid})
